...
echo  "<tr><th>USN</th><th>NAME</th><th>ADDRESS</th><th>EMAIL</th></tr>"; if  ($result->num_rows  >  0)
{
while($row  =  $result->fetch_assoc())
{
echo  "<tr><td>".  $row["usn"]."</td>";
echo  "<td>".  $row["name"]."</td>";
echo  "<td>".  $row["address"]."</td>"; echo  "<td>".  $row["email"]."</td></tr>";
$usn[]  =  $row["usn"]  ;
}
}
$n = sizeof($usn) ;
...
echo  "<br><table  border='2'><caption>After  Sorting  </caption><br>";  echo  "<tr><th>USN</th><th>NAME</th><th>ADDRESS</th><th>EMAIL</th></tr>"; for($i  =  0  ;  $i  <  sizeof($usn)  ;  $i++)
{
